    ...
    async execute(client, message, args) {
        ...
        try{
            if(!args[0]) {
                ...
                .addField(`Joined At`, `${moment(member.user.joinedAt).format('ddd, MMM Do, YYYY, h:mm a')}`, true)
                .addField(`Created At`, `${moment(member.user.createdAt).format('ddd, MMM Do, YYYY, h:mm a')}`, true)
